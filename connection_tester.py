    ...
    def __init__(self, database_name: str = DATABASE_NAME)->None:
        try:
            ...
            if MongoDBClient.client is None: ##check initially the client is none or not
                URI="mongodb+srv://sarojrailive:Kv7d2TNjorilF0xI@cluster0.20vbusf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
                mongodb_url=URI ##fetch the mongodb url to establish the client
